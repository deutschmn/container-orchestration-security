...
\begin{itemize}
    ...
    \item The service account the Dashboard is using should have limited privileges so that users cannot misuse its permissions when choosing not to sign in with their account.
