...
% TODO write about admission control
...
In most cases, it makes sense to prohibit egress by default. In this case, even if a pod is entirely hijacked, it cannot directly communicate with the outside world. Of course, however, such a restriction could be bypassed by using a reverse proxy, yet would require more effort from the attacker. % TODO would you really call that "reverse proxy"?
